...
#define SOCKET_READABLE(x,z) \
  Curl_socket_check(x, CURL_SOCKET_BAD, CURL_SOCKET_BAD, (time_t)z, FALSE)
#define SOCKET_WRITABLE(x,z) \
  Curl_socket_check(CURL_SOCKET_BAD, CURL_SOCKET_BAD, x, (time_t)z, FALSE)

int Curl_poll(struct pollfd ufds[], unsigned int nfds, int timeout_ms,
              bool ack_eintr);
int Curl_wait_ms(int timeout_ms, bool Curl_ack_eintr);
